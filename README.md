...
|  "Paper A cites Paper B" | → |  Directed Edge (A → B) |
...
|  Fuzzy / typo-tolerant search | **Wagner–Fischer edit distance** |
...
-  **Traverse** the citation graph (BFS/DFS) to reveal direct & indirect relationships
